...
- [ ] Abilities & Spells adapts to each character and groups ancestry/species, background, class/subclass, feat, passive, and limited-use features without showing empty spell UI to non-spellcasters. *(Feature, feat, passive, and resource management complete; spellcasting pending.)*
