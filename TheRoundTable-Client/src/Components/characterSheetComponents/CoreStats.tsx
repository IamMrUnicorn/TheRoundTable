  ...
  return (
    <div className="flex flex-row font-accent capitalize h-40 bg-yellow-100">
      <div className="flex justify-around w-full items-center ">
        <div className="text-center text-lg border border-solid border-black rounded-2xl bg-red-400 w-20 h-20 lg:w-24 lg:h-24 transform rotate-45 relative">
        ...
        <div className="text-center text-lg border border-solid border-black rounded-2xl bg-orange-400 w-20 h-20 lg:w-24 lg:h-24 transform rotate-45 relative">
          <div className="transform -rotate-45 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
            dexterity <br />
        ...
        <div className="text-center text-lg border border-solid border-black rounded-2xl bg-yellow-400 w-20 h-20 lg:w-24 lg:h-24 transform rotate-45 relative">
          <div className="transform -rotate-45 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
            constitution <br />
        ...
        <div className="text-center text-lg border border-solid border-black rounded-2xl bg-green-400 w-20 h-20 lg:w-24 lg:h-24 transform rotate-45 relative">
          <div className="transform -rotate-45 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
            intelligence <br />
        ...
        <div className="text-center text-lg border border-solid border-black rounded-2xl bg-blue-400 w-20 h-20 lg:w-24 lg:h-24 transform rotate-45 relative">
          <div className="transform -rotate-45 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
            wisdom <br />
        ...
        <div className="text-center text-lg border border-solid border-black rounded-2xl bg-purple-400 w-20 h-20 lg:w-24 lg:h-24 transform rotate-45 relative">
          <div className="transform -rotate-45 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
            charisma <br />
