...
const CharacterForm = ({ user_id }: CharacterPageProps) => {
  ...
  const customChip = (item: string) => {
    return (
      <div className='rounded-lg bg-primary text-center w-min whitespace-nowrap p-1'>
    ...
    <form className='flex flex-col' onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className='flex flex-col lg:flex-row gap-1 items-center lg:items-baseline lg:justify-center '>
        ...
        <div className='flex flex-col gap-1 w-min items-end '>
          ...
          <label>  Race:  <Controller name="race" control={control} defaultValue={[]} render={({ field }) => (<Chips pt={{inputToken: {className: 'text-black bg-slate-400'}, container: {className: 'flex flex-row'}}} value={field.value} onChange={(e) => field.onChange(e.value || [])} itemTemplate={customChip} />)} /> {errors.race && <p className='text-red-500'>At least 1 race is required</p>} </label>
          <label>  Class:  <Controller name="class" control={control} defaultValue={[]} render={({ field }) => (<Chips pt={{inputToken: {className: 'text-black bg-slate-400'}, container: {className: 'flex flex-row'}}} value={field.value} onChange={(e) => field.onChange(e.value || [])} itemTemplate={customChip} />)} />{errors.class && <p className='text-red-500'>At least 1 class is required</p>} </label>
          <label>  Subclass:  <Controller name="subclass" control={control} defaultValue={[]} render={({ field }) => (<Chips pt={{inputToken: {className: 'text-black bg-slate-400'}, container: {className: 'flex flex-row'}}} value={field.value} onChange={(e) => field.onChange(e.value || [])} itemTemplate={customChip} />)} />{errors.subclass && <p className='text-red-500'>At least 1 subclass is required</p>} </label>
          ...
          <label>  languages:  <Controller name="languages" control={control} defaultValue={[]} render={({ field }) => (<Chips pt={{inputToken: {className: 'text-black bg-slate-400'}, container: {className: 'flex flex-row'}}} value={field.value} onChange={(e) => field.onChange(e.value || [])} itemTemplate={customChip} />)} /> </label>
        </div>
        <div className='flex flex-col items-center lg:items-end w-min flex-wrap gap-1'>
          ...
          <label>   Feats: <Controller name="feats" control={control} defaultValue={[]} render={({ field }) => (<Chips pt={{inputToken: {className: 'text-black bg-slate-400'}, container: {className: 'flex flex-row'}}} value={field.value} onChange={(e) => field.onChange(e.value || [])} itemTemplate={customChip} />)} /> </label>
          <label>  other proficiencies: <Controller name="proficiencies" control={control} defaultValue={[]} render={({ field }) => (<Chips pt={{inputToken: {className: 'text-black bg-slate-400'}, container: {className: 'flex flex-row'}}} value={field.value} onChange={(e) => field.onChange(e.value || [])} itemTemplate={customChip} />)} /> </label>
        </div>
        <div className='flex flex-col items-end w-min whitespace-nowrap gap-1'>
          <p className='self-center'>Saving Throws</p>
          ...
          <p className='self-center py-2'>Skills</p>
          ...
          <label>  Animal Handling:   <Controller name="animalHandlingProficient" control={control} defaultValue={false} render={({ field: { ref, value, ...restField } }) => <input type="checkbox" {...restField} ref={ref} checked={!!value} />} /> </label>
          ...
          <label>  Sleight of Hand:  <Controller name="sleightOfHandProficient" control={control} defaultValue={false} render={({ field: { ref, value, ...restField } }) => <input type="checkbox" {...restField} ref={ref} checked={!!value} />} /></label>
        ...
        <div className='flex flex-col items-end w-min flex-wrap gap-1'>
          ...
          <label>  inventory: <Controller name="inventory" control={control} defaultValue={[]} render={({ field }) => (<Chips pt={{inputToken: {className: 'text-black bg-slate-400'}, container: {className: 'flex flex-row'}}} value={field.value} onChange={(e) => field.onChange(e.value || [])} itemTemplate={customChip} />)} /> </label>
        </div>
        <div className='flex flex-col items-center lg:items-end w-min flex-wrap gap-1'>
          <p className='self-center'>spells</p>
          <label> Cantrips: <Controller name="cantrips" control={control} defaultValue={[]} render={({ field }) => (<Chips pt={{inputToken: {className: 'text-black bg-slate-400'}, container: {className: 'flex flex-row'}}} value={field.value} onChange={(e) => field.onChange(e.value || [])} itemTemplate={customChip} />)} /> </label>
          <label> lvl1: <Controller name="lvl1" control={control} defaultValue={[]} render={({ field }) => (<Chips pt={{inputToken: {className: 'text-black bg-slate-400'}, container: {className: 'flex flex-row'}}} value={field.value} onChange={(e) => field.onChange(e.value || [])} itemTemplate={customChip} />)} /> </label>
          <label> lvl2: <Controller name="lvl2" control={control} defaultValue={[]} render={({ field }) => (<Chips pt={{inputToken: {className: 'text-black bg-slate-400'}, container: {className: 'flex flex-row'}}} value={field.value} onChange={(e) => field.onChange(e.value || [])} itemTemplate={customChip} />)} /> </label>
          <label> lvl3: <Controller name="lvl3" control={control} defaultValue={[]} render={({ field }) => (<Chips pt={{inputToken: {className: 'text-black bg-slate-400'}, container: {className: 'flex flex-row'}}} value={field.value} onChange={(e) => field.onChange(e.value || [])} itemTemplate={customChip} />)} /> </label>
          <label> lvl4: <Controller name="lvl4" control={control} defaultValue={[]} render={({ field }) => (<Chips pt={{inputToken: {className: 'text-black bg-slate-400'}, container: {className: 'flex flex-row'}}} value={field.value} onChange={(e) => field.onChange(e.value || [])} itemTemplate={customChip} />)} /> </label>
          <label> lvl5: <Controller name="lvl5" control={control} defaultValue={[]} render={({ field }) => (<Chips pt={{inputToken: {className: 'text-black bg-slate-400'}, container: {className: 'flex flex-row'}}} value={field.value} onChange={(e) => field.onChange(e.value || [])} itemTemplate={customChip} />)} /> </label>
          <label> lvl6: <Controller name="lvl6" control={control} defaultValue={[]} render={({ field }) => (<Chips pt={{inputToken: {className: 'text-black bg-slate-400'}, container: {className: 'flex flex-row'}}} value={field.value} onChange={(e) => field.onChange(e.value || [])} itemTemplate={customChip} />)} /> </label>
          <label> lvl7: <Controller name="lvl7" control={control} defaultValue={[]} render={({ field }) => (<Chips pt={{inputToken: {className: 'text-black bg-slate-400'}, container: {className: 'flex flex-row'}}} value={field.value} onChange={(e) => field.onChange(e.value || [])} itemTemplate={customChip} />)} /> </label>
          <label> lvl8: <Controller name="lvl8" control={control} defaultValue={[]} render={({ field }) => (<Chips pt={{inputToken: {className: 'text-black bg-slate-400'}, container: {className: 'flex flex-row'}}} value={field.value} onChange={(e) => field.onChange(e.value || [])} itemTemplate={customChip} />)} /> </label>
          <label> lvl9: <Controller name="lvl9" control={control} defaultValue={[]} render={({ field }) => (<Chips pt={{inputToken: {className: 'text-black bg-slate-400'}, container: {className: 'flex flex-row'}}} value={field.value} onChange={(e) => field.onChange(e.value || [])} itemTemplate={customChip} />)} /> </label>
        </div>
        <div className='flex flex-col items-center lg:items-end w-min mb-3 lg:m-0  gap-1'>
          <p className='self-center'>weapons</p>
          <label> heavy: <Controller name="heavy" control={control} defaultValue={[]} render={({ field }) => (<Chips pt={{root:{className: 'flex flex-col'}, inputToken: {className: 'text-black bg-white'}, container: {className: 'flex flex-row'}}} value={field.value} onChange={(e) => field.onChange(e.value || [])} itemTemplate={customChip} />)} /> </label>
          <label> light: <Controller name="light" control={control} defaultValue={[]} render={({ field }) => (<Chips pt={{root:{className: 'flex flex-col'}, inputToken: {className: 'text-black bg-white'}, container: {className: 'flex flex-row'}}} value={field.value} onChange={(e) => field.onChange(e.value || [])} itemTemplate={customChip} />)} /> </label>
          <label> reach: <Controller name="reach" control={control} defaultValue={[]} render={({ field }) => (<Chips pt={{root:{className: 'flex flex-col'}, inputToken: {className: 'text-black bg-white'}, container: {className: 'flex flex-row'}}} value={field.value} onChange={(e) => field.onChange(e.value || [])} itemTemplate={customChip} />)} /> </label>
          <label> range: <Controller name="range" control={control} defaultValue={[]} render={({ field }) => (<Chips pt={{root:{className: 'flex flex-col'}, inputToken: {className: 'text-black bg-white'}, container: {className: 'flex flex-row'}}} value={field.value} onChange={(e) => field.onChange(e.value || [])} itemTemplate={customChip} />)} /> </label>
          <label> thrown: <Controller name="thrown" control={control} defaultValue={[]} render={({ field }) => (<Chips pt={{root:{className: 'flex flex-col'}, inputToken: {className: 'text-black bg-white'}, container: {className: 'flex flex-row'}}} value={field.value} onChange={(e) => field.onChange(e.value || [])} itemTemplate={customChip} />)} /> </label>
          <label> loading: <Controller name="loading" control={control} defaultValue={[]} render={({ field }) => (<Chips pt={{root:{className: 'flex flex-col'}, inputToken: {className: 'text-black bg-white'}, container: {className: 'flex flex-row'}}} value={field.value} onChange={(e) => field.onChange(e.value || [])} itemTemplate={customChip} />)} /> </label>
          <label> finesse: <Controller name="finesse" control={control} defaultValue={[]} render={({ field }) => (<Chips pt={{root:{className: 'flex flex-col'}, inputToken: {className: 'text-black bg-white'}, container: {className: 'flex flex-row'}}} value={field.value} onChange={(e) => field.onChange(e.value || [])} itemTemplate={customChip} />)} /> </label>
          <label> special: <Controller name="special" control={control} defaultValue={[]} render={({ field }) => (<Chips pt={{root:{className: 'flex flex-col'}, inputToken: {className: 'text-black bg-white'}, container: {className: 'flex flex-row'}}} value={field.value} onChange={(e) => field.onChange(e.value || [])} itemTemplate={customChip} />)} /> </label>
          <label> versatile: <Controller name="versatile" control={control} defaultValue={[]} render={({ field }) => (<Chips pt={{root:{className: 'flex flex-col'}, inputToken: {className: 'text-black bg-white'}, container: {className: 'flex flex-row'}}} value={field.value} onChange={(e) => field.onChange(e.value || [])} itemTemplate={customChip} />)} /> </label>
          <label> twoHanded: <Controller name="twoHanded" control={control} defaultValue={[]} render={({ field }) => (<Chips pt={{root:{className: 'flex flex-col'}, inputToken: {className: 'text-black bg-white'}, container: {className: 'flex flex-row'}}} value={field.value} onChange={(e) => field.onChange(e.value || [])} itemTemplate={customChip} />)} /> </label>
          <label> magicalWeapons: <Controller name="magicalWeapons" control={control} defaultValue={[]} render={({ field }) => (<Chips pt={{root:{className: 'flex flex-col'}, inputToken: {className: 'text-black bg-white'}, container: {className: 'flex flex-row'}}} value={field.value} onChange={(e) => field.onChange(e.value || [])} itemTemplate={customChip} />)} /> </label>
        </div>
