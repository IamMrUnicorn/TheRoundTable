  ...
  return (
    <div className="h-[95vh] flex flex-col text-white items-center justify-evenly bg-black ">
      ...
      <div className='flex flex-col justify-center'>
        ...
        <a className="btn btn-accent  self-center m-5 w-1/4 font-accent capitalize text-lg" href="/info">New Here?</a>
        <a className="btn btn-accent  self-center m-5 w-1/4 font-accent capitalize " href="/guide">New to DnD?</a>
      ...
      <div className='flex flex-col justify-center'>
        ...
        <p className="font-accent self-center m-1">Or</p>
        <div className='flex flex-row justify-center'>
          <input className='self-center rounded-lg p-2 m-1 font-accent text-black' type='text' placeholder="Enter your party name" onChange={(e) => { setCode(e.target.value) }}></input>
          <a className='btn btn-accent capitalize font-accent m-1' href={`rooms/${code}`}>join room</a>
        </div>
      </div>
