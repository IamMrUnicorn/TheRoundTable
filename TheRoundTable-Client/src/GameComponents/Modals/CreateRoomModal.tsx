  ...
  return (
    <>
      ...
      <div className="modal">
        ...
        <label className='mx-auto '>  are you the DM?:   
        ...
        <label className='mx-auto '>  enter your party / campaign name: 
        <br/>
          <Controller name="name" control={control} defaultValue="" render={({ field }) => <input className='text-black ml-6 p-2 rounded-lg m-1' type="text" {...field} />} />  {errors.name && <p className='text-red-500 pl-7'>party/campaign name is required</p>} 
        </label>

          <div className="flex flex-row m-3 mx-auto ">
            <input type='submit' className="btn mx-2" value='create room'/>
            <label htmlFor="createRoom_modal" className="btn mx-2" onClick={() => {setPopup(false)}}>Cancel</label>
          </div>
